package net.mythicisland.template.api.internal.nats;
...
public final class NatsFailoverConnectionManager {
    ...
    public NatsFailoverConnectionManager(
        ...
        this.monitorExecutor = Executors.newSingleThreadScheduledExecutor(daemonFactory("mythicisland-nats-failover-monitor"));
        this.reconnectExecutor = Executors.newSingleThreadScheduledExecutor(daemonFactory("mythicisland-nats-failover-reconnect"));
